...
struct CData
{
	double *Pot, *dPdR, Rm, RM, MaxX, MaxY, MaxZ, PS, U, T, MPD, MPPD, MRSc, MPRSc;
	Particle *P;
	int N, NM, XS, YS, ZS, GridSizeDiv, **MG, MXS, MZS;
};
...
class Calculation : public QThread
{
	...
	private:
		...
		double Energy, ScF, E, h, Re;
		double *XP, *YP, *ZP, *MXP, *MYP, *MZP, *MX, *MY, *MZ, *MvX, *MvY, *MvZ;
		int nx, ny, nz, *MD;
		Particle *P, ****G, **D;
		bool Run, *M;
		CData CD;
...
{
	CData *CD;
	double *tx, *ty, *tz, *ax, *ay, *az, *mtx, *mty, *mtz, *max, *may, *maz;
	int n;
};
...
{
	CData *CD;
	double *mtx, *mty, *mtz, *max, *may, *maz;
	int n;
};
